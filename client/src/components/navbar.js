...
const AppNavbar = () => {
    ...
    return (
        <Navbar fixed="top" expand='md' bg='light' variant="light" className="p-3 px-4">
            ...
            <Navbar.Toggle aria-controls="responsive-navbar-nav" style={{ backgroundColor: '#fff', borderColor: '#fff'}}/>
            <Navbar.Collapse id="responsive-navbar-nav">
                <Nav className="text-lg text-hover-dark ms-auto">
                    <Nav.Link onClick={scrollToTop} style={{ fontWeight: 'bold'}}>Home</Nav.Link>
                    <Nav.Link as={Link} to='workExp' smooth duration={500} style={{ fontWeight: 'bold', cursor: 'pointer'}}>
                        About me
                    </Nav.Link>
